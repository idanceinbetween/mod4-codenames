    ...
    return (
      <AbsoluteWrapper>
        <Segment raised textAlign='left'>
          ...
          <p>
            IMPORTANT: you MUST update the seed file manually after using this
            feature. Do not erase the database before updating the seed file.
            The seed file should reflect the current database of words.
          </p>
        </Segment>
        <Segment raised textAlign='left'>
          <h5>
            Refine word database here. Click keep or delete to get another
            random word to decide on.
          </h5>
          <h1>{this.state.word.word}</h1>
          <button className='ui button' onClick={this.handleKeep}>
            Keep
          </button>
          <button className='ui button' onClick={this.deleteWordFromServer}>
            DESTROY
          </button>
        </Segment>
        <Segment raised textAlign='left'>
