            ...
            <Grid.Column width={10}>
              <Segment.Group>
                <Segment raised textAlign='left'>
                  ...
                  <p>
                    This project CodenamesIB is a digital re-creation of
                    Codenames, a card game loved by the Inglorious BA$Hterds
                    cohort at Flatiron School, London. It is created as a
                    project for Mod 4 of the bootcamp where we focused on
                    creating React.
                  </p>
                ...
                <Segment textAlign='left'>
                  ...
                  <p>
                    Codenames is a 2015 card game for 4–8 players designed by
                    Vlaada Chvátil and published by Czech Games.
                  </p>
                  <p>
                    Two teams compete by each having a Spymaster give one word
                    clues which can point to multiple words on the board. The
                    other players on the team attempt to guess their team's
                    words while avoiding the words of the other team. In the 2–3
                    player variant, one Spymaster gives clues to the other
                    player or players.{' '}
                  </p>
                  <p>
                    In 2016 Codenames won the Spiel des Jahres award for the
